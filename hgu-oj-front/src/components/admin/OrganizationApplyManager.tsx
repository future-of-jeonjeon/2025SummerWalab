    ...
    <Card padding="lg">
      <div className="space-y-6">
        <div className="space-y-1">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">단체 신청 목록</h2>
        </div>
          ...
          <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto" padding="lg">
            <div className="space-y-6">
              ...
              <div className="space-y-2 border-t pt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 dark:border-slate-700 text-sm text-gray-800 dark:text-slate-200 leading-relaxed whitespace-pre-wrap">
              ...
              {selectedApply.img_url && (
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-100 dark:bg-slate-800 rounded-lg p-2 inline-block">
                    <img
