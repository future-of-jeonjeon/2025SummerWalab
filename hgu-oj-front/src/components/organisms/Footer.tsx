            ...
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 2xl:max-w-screen-2xl 2xl:px-10">
                ...
                <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-[14px] text-gray-500 font-medium">
                        © 2024 Handong Code Round Inc. All rights reserved.
                    </p>
                    <div className="flex gap-5">
                        {/* GitHub Icon */}
                        <a href="https://github.com/HGU-code-round" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#333] transition-colors">
