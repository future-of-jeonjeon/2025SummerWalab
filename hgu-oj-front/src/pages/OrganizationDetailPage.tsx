        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav className="flex mb-6 text-sm text-gray-500">
                    <span className="cursor-pointer hover:text-gray-900" onClick={() => navigate('/organizations')}>Organizations</span>
                    <span className="mx-2">/</span>
                    <span className="text-gray-900 font-medium truncate">{organization.name}</span>
                </nav>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-gray-50 px-8 py-3 border-t border-gray-200 flex items-center justify-between sm:px-6">
